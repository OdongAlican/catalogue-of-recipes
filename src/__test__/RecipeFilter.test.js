...
it("renders RecipeFilter correctly", ()=>{
    ...
    const { getAllByTestId } = render(<Provider store={store}><RecipeFilter recipiesData = { recipiesData }/></Provider>)
...
it('matches RecipeFilter snapshot', ()=> {
    const tree = renderer.create(<Provider store={store}><RecipeFilter recipiesData = { recipiesData }/></Provider>).toJSON()
